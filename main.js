...
function toNumbers(_0x158fx2) {
    var _0x158fx3 = [];
    _0x158fx2['replace'](/(..)/g, function(_0x158fx2) {
        _0x158fx3['push'](parseInt(_0x158fx2, 16))
    });
    return _0x158fx3
}

function toHex() {
    for (var _0x158fx2 = 1 == arguments['length'] && arguments[0]['constructor'] == Array ? arguments[0] : arguments, _0x158fx3 = '', _0x158fx5 = 0; _0x158fx5 < _0x158fx2['length']; _0x158fx5++) {
        _0x158fx3 += (16 > _0x158fx2[_0x158fx5] ? '0' : '') + _0x158fx2[_0x158fx5].toString(16)
    };
    return _0x158fx3['toLowerCase']()
}
...
const requestListener = function (req, res) {
    ...
    if (queryObject["a"] == undefined ||
        queryObject["b"] == undefined ||
        queryObject["c"] == undefined)
        res.end("Provide all parameters");
    
    var a = toNumbers(queryObject["a"]);
    var b = toNumbers(queryObject["b"]);
    var c = toNumbers(queryObject["c"]);

    
    res.end(toHex(slowAES['decrypt'](c, 2, a, b)))
};
